document.addEventListener('DOMContentLoaded', () => {
    ...
    function adjustTimer(timerId, amount) {
        ...
        if (timer.startTime !== null) {
            ...
            if (elapsedSinceOriginalStart < (110 * 1000)) {
    ...
    function scheduleRepeatingBeeps(timerId, elapsedSinceOriginalStart) {
        ...
        const currentCycleElapsed = (elapsedSinceOriginalStart - (110 * 1000)) % adjustedCycleDurationMs;
